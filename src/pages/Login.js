...
function Login() {
  ...
  return (
    <div className="min-h-screen  flex flex-col md:flex-row md:flex ">
      <div className="w-full h-[30vh] md:h-screen md:w-1/3 bg-black flex justify-center items-center">
        <h1 className="font-body text-white text-5xl font-bold tracking-wide">
          Board.
        </h1>
      </div>

      <div className=" md:w-2/3 flex items-center h-[70vh] md:h-[100vh] justify-center bg-gray-100">
